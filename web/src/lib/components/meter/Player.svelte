...
{#if player.dead}
    <div class="ml-0.5 flex items-center justify-center"
        ...
        <IconSkull/>
        {#if hovered}
            <div class="absolute flex flex-row items-center justify-center p-1 z-50 rounded-lg whitespace-nowrap bg-bouquet-50 border border-[#c58597] -translate-y-[calc(100%-0.1rem)] text-[#575279]">
                <IconSkull/>
