...
const (
	...
	Admin_DeleteUserLogs_FullMethodName = "/admin.Admin/DeleteUserLogs"
)
...
type AdminClient interface {
	...
	DeleteUserLogs(ctx context.Context, in *DeleteUserLogsRequest, opts ...grpc.CallOption) (*DeleteUserLogsResponse, error)
}
...
func (c *adminClient) DeleteUserLogs(ctx context.Context, in *DeleteUserLogsRequest, opts ...grpc.CallOption) (*DeleteUserLogsResponse, error) {
	out := new(DeleteUserLogsResponse)
	err := c.cc.Invoke(ctx, Admin_DeleteUserLogs_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdminServer interface {
	...
	DeleteUserLogs(context.Context, *DeleteUserLogsRequest) (*DeleteUserLogsResponse, error)
...
func (UnimplementedAdminServer) DeleteUserLogs(context.Context, *DeleteUserLogsRequest) (*DeleteUserLogsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteUserLogs not implemented")
}
...
func _Admin_DeleteUserLogs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteUserLogsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServer).DeleteUserLogs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Admin_DeleteUserLogs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServer).DeleteUserLogs(ctx, req.(*DeleteUserLogsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Admin_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeleteUserLogs",
			Handler:    _Admin_DeleteUserLogs_Handler,
		},
	},
