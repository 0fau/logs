...
import (
	...
	structs "github.com/0fau/logs/pkg/process/structs"
...
const createGroupedEncounter = `-- name: CreateGroupedEncounter :exec
...
func (q *Queries) CreateGroupedEncounter(ctx context.Context, arg CreateGroupedEncounterParams) error {
	_, err := q.db.Exec(ctx, createGroupedEncounter, arg.GroupID, arg.Uploaders)
	return err
}
...
const deleteUserLogs1 = `-- name: DeleteUserLogs1 :many
DELETE
FROM encounters
...
func (q *Queries) DeleteUserLogs1(ctx context.Context, uploadedBy pgtype.UUID) ([]int32, error) {
	rows, err := q.db.Query(ctx, deleteUserLogs1, uploadedBy)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const deleteUserLogs2SelectGroups = `-- name: DeleteUserLogs2SelectGroups :many
SELECT id
FROM encounters
WHERE uploaded_by = $1
  AND id = unique_group
...
func (q *Queries) DeleteUserLogs2SelectGroups(ctx context.Context, uploadedBy pgtype.UUID) ([]int32, error) {
	rows, err := q.db.Query(ctx, deleteUserLogs2SelectGroups, uploadedBy)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const deleteUserLogs3PruneGroupedEncounters = `-- name: DeleteUserLogs3PruneGroupedEncounters :exec
DELETE
...
func (q *Queries) DeleteUserLogs3PruneGroupedEncounters(ctx context.Context, dollar_1 []int32) error {
	_, err := q.db.Exec(ctx, deleteUserLogs3PruneGroupedEncounters, dollar_1)
	return err
}

const deleteUserLogs3UpdateGroupedEncounters = `-- name: DeleteUserLogs3UpdateGroupedEncounters :many
...
func (q *Queries) DeleteUserLogs3UpdateGroupedEncounters(ctx context.Context, dollar_1 pgtype.UUID) ([]int32, error) {
	rows, err := q.db.Query(ctx, deleteUserLogs3UpdateGroupedEncounters, dollar_1)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetAPIToken(ctx context.Context, token string) (ApiToken, error) {
	...
	var i ApiToken
	err := row.Scan(&i.UserID, &i.Token, &i.Grade)
	return i, err
}
...
const listUserEncounters = `-- name: ListUserEncounters :many
SELECT id
FROM encounters
WHERE uploaded_by = $1
`
...
func (q *Queries) ListUserEncounters(ctx context.Context, uploadedBy pgtype.UUID) ([]int32, error) {
	rows, err := q.db.Query(ctx, listUserEncounters, uploadedBy)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
